...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-b-2 py-2 border-gray-200 dark:bg-gray-900 dark:border-0">
        <div className=" flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2">
            <button
              ...
              className="flex items-center py-1 px-2 mr-2 text-xs font-medium text-gray-700 bg-white rounded-lg border border-gray-200 toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10  dark:bg-gray-700 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
            >
              {darkMode ? (
                <svg
                  aria-hidden="true"
            ...
            <button
              data-collapse-toggle="navbar-search"
              type="button"
              className={`inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:${
                hidden ? 'hidden ' : ''
